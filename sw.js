// NovaTEch BD — Service Worker v3.3
// ✅ Spark plan compatible — No FCM needed
// ✅ Browser Push Notification
// ✅ Offline Sync

const CACHE = 'novatech-v7'; // ✅ BUG-08 FIX
const FONT_CACHE = 'novatech-fonts';

// GitHub Pages subpath support — dynamic path detection
...
self.addEventListener('install', e => {
  e.waitUntil(
    caches.open(CACHE)
      .then(c => c.addAll(STATIC).catch(() => {})) // fail silently
