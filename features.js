...
(function () {
  ...
  style.textContent = `
    ...
    /* ══ CHAT SYSTEM v2 ══ */
    .chat-screen{display:flex;flex-direction:column;height:calc(100vh - 120px);background:var(--bg);}
    /* Conversation List */
    ...
    /* Chat Room */
    .chat-room-wrap{display:flex;flex-direction:column;height:calc(100vh - 120px);}
