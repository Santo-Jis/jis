...
async function initFCMPushNotification() {
  try {
    ...
    // ✅ BUG-03 FIX: _unsubs এ রাখি — logout এ বন্ধ হবে
    ...
    _unsubs.push(_notifUnsub); // ✅ BUG-03 FIX: logout এ বন্ধ হবে
  ...
  try {
    ...
    for (const sale of pending) {
      ...
      try {
        ...
        // ✅ BUG-02 FIX: runTransaction — offline sync duplicate বন্ধ
...
function syncGlobals(){
  ...
  // ✅ BUG-01 FIX: আগে define হয়ে থাকলে আবার define করব না — TypeError বন্ধ
...
window.sendAIChat=async()=>{
  ...
  msgs.scrollTop=msgs.scrollHeight;
  // ✅ BUG-04 FIX: Firebase থেকে key নিই, window._ntAIKey নয়
  try{
