...
::-webkit-scrollbar-thumb{background:var(--surf3);border-radius:2px}`;
  ...
  // ─────────────────────────────────────────
  function hideOrig() {
    // পুরনো dashboard পুরোটা hide করো
    ...
    // sum-grid ও filter buttons hide
    document.querySelectorAll('#page-dash .sum-grid, #page-dash .df, #page-dash #myTargetCard').forEach(e=>e.style.display='none');
  }
