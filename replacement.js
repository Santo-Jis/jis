  ...
  waitForApp(() => {
    ...
    window.generateInvoice = function(saleId) {
      ...
      setTimeout(() => {
        ...
        // deduct case: ফেরত মাল বিল থেকে বাদ — netDue = saleDue - retTotal
              ...
              <div style="position:relative">
                ...
                <div style="background:#f8fafc;border:1.5px solid #e2e8f0;border-radius:10px;padding:10px">
                  ...
                  <div style="display:flex;justify-content:space-between;font-size:11px;color:#64748b;padding:4px 0;border-bottom:1px solid #f1f5f9">
                    <span>মূল বিল ছিল</span>
                    <span style="font-weight:700;color:#1e293b">৳${Math.round(sale?.total||0)}</span>
                  </div>` : saleDue > 0 ? `
                  <div style="display:flex;justify-content:space-between;font-size:11px;color:#64748b;padding:4px 0;border-bottom:1px solid #f1f5f9">
                  ...
                  <div style="display:flex;justify-content:space-between;font-size:11px;color:#d97706;padding:4px 0;border-bottom:1.5px solid #cbd5e1;margin-bottom:8px;font-style:italic">
                    <span>মূল বিল থেকে বিয়োগ হয়েছে</span>
                    <span style="font-weight:700">- ৳${Math.round(rpl.retTotal||0)}</span>
                  </div>`}
                  ...
                  <div style="padding:12px;border-radius:10px;text-align:center;background:${isDeduct?'#f0fdf4':netDue>0?'#eff6ff':netDue<0?'#fffbeb':'#f0fdf4'};border:1.5px solid ${isDeduct?'#86efac':netDue>0?'#93c5fd':netDue<0?'#fde68a':'#86efac'}">
                    ${isDeduct ? `
                      ${netDue === 0 ? `
                        <div style="font-size:14px;font-weight:800;color:#059669">✅ ফেরত মাল বিলের সাথে সমন্বয় হয়ে গেছে!</div>
                        <div style="font-size:10px;color:#64748b;margin-top:4px">কোনো বাকি নেই</div>
                      ` : `
                        <div style="font-size:11px;color:#64748b;margin-bottom:4px">ফেরত মালের পর আপনার বাকি</div>
                        ...
                        <div style="font-size:10px;color:#3b5fc0;margin-top:6px;padding:5px 8px;background:white;border-radius:6px">
                          ফেরত মাল ${bn(rpl.retTotal||0)} বিল থেকে বাদ দেওয়া হয়েছে
                        </div>
                      `}
                    ` : netDue > 0 ? `
