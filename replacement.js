              ...
              <div style="position:relative">
                ...
                <div style="background:#f8fafc;border:1.5px solid #e2e8f0;border-radius:10px;padding:10px">
                  ...
                  <div style="padding:12px;border-radius:10px;text-align:center;background:${netDue>0?'#eff6ff':netDue<0?'#fffbeb':'#f0fdf4'};border:1.5px solid ${netDue>0?'#93c5fd':netDue<0?'#fde68a':'#86efac'}">
                    ${netDue > 0 ? `
                      <div style="font-size:11px;color:#64748b;margin-bottom:4px">আপনি আমাদের কাছে পাওনা</div>
                      <div style="font-size:32px;font-weight:900;color:#1d4ed8;line-height:1">৳${netAbs}</div>
                      <div style="font-size:10px;color:#64748b;margin-top:6px;padding:5px 8px;background:white;border-radius:6px">
                        পরেরবার মাল নেওয়ার সময় এই টাকা দিলেই হবে
                      </div>
                    ` : netDue < 0 ? `
                      <div style="font-size:11px;color:#92400e;margin-bottom:4px">আমরা আপনার কাছে পাওনা</div>
                      ...
                      <div style="font-size:10px;color:#92400e;margin-top:6px;padding:5px 8px;background:white;border-radius:6px">
                        📦 নগদ দেওয়া হয় না<br>পরেরবার মাল নেওয়ার সময় <strong>৳${netAbs}</strong> এর মাল বিনামূল্যে পাবেন
                      </div>
                    ` : `
